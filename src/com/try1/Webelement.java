...
public static void main(String[] args) throws MalformedURLException, InterruptedException
{
	...
	appiumDriver.findElement(By.name("Companies")).click();
	 ...
	 Point sliderLocation = new Point(upperleft.getX() , upperleft.getY() + dimensions.getHeight()/2); 
	 action.press(sliderLocation.getX(), sliderLocation.getY()).waitAction(200).moveTo(sliderLocation.getX(), sliderLocation.getY()+(sliderLocation.getY()-1)).release().perform();
}
}
